...
urlpatterns = [
    ...
    url(r'^product/(?P<pk>\d+)/$', products_view.product_request_refine, name = 'product_refine'),
    ...
    url(r'^api/get_analysis_settings/', products_view.get_analysis_settings, name = 'analysis_settings'),
    url(r'^api/get_enabled_parameters_by_aggp', products_view.get_enabled_parameters_by_aggp, name = 'get_enabled_parameters_by_aggp'),
